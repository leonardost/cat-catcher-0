...
function _update()
  ...
  if stage == 4 then
    if t % 300 == 0 then
      floor1 = flr(rnd(3))
      floor2 = flr(rnd(3))
		    local portals = create_portals_between(floor1, floor2)
    ...
    if obj.is_portal and obj.direction == 0 then
      for obj2 in all(actors) do
        ...
        then
          ...
          obj2.y = floor_base_y + (16 - obj2.h) + obj2.floor * 32
        end 
      end
    end
...
function _draw()
  ...
  elseif game_state == 6 then
	   print("congratulations!", 32, 61)
	   print("you beat the game!", 28, 78)
    ...
    elseif stage == 4 then
      ...
      -- vine 2		    
		  ...
		  for gfx in all(actors) do
		    if gfx.draw != nil and not gfx.delete_me then
		      if gfx.swap_colors then
  		      ...
  		      gfx.draw()
  		      -- space helmets for cats
  		      if gfx.is_cat and stage == 4 then
  		        local head = gfx.head_position()
  		        circ(head[1], head[2], head[3], 7)
  		      end
  		    end
		    end
        ...
        -- helmet
		  ...
		  if stage == 4 and not elevator.is_changing_floors() then
		    circ(girl.x + 9, girl.y + 5, 8, 7)
		  end
...
function base_cat_actor(sprites, floor)
  ...
  function cat.head_position()
    return { cat.x + 1, cat.y + 1, 3 }
  end
...
cat_map = {
  ...
  -- 10 - white fast cat
  cat_actor7,
  -- 11 - big cat with helmet
  bigcat_actor5,
  -- 12 - big black cat with helmet
  bigcat_actor6,
  -- 13 - bonus green cat
  cat_actor_bonus,
  -- 14 - black cat
...
function create_portals_between(floor1, floor2)
  ...
  local portal_exit = portal_actor(48, floor_base_y - 2 + floor2 * 32, 1)
  portal_entrance.move_to_x = portal_exit.x
...
function doraemon()
  ...
  local sprites = {
    sprite(2, 2, { 169, 170, 185, 186 }),
  }
  local animation_idle = animation()
  animation_idle.add_frame(sprites[1], 30)
  local idle = state("idle", animation_idle)

  local doraemon = actor(
    128, 8, { idle }
  )
  function doraemon.update()
    t += 1
    
    if t < 30 and t % 2 == 0 then
      doraemon.x -= 1
    elseif t > 60 and t % 2 == 0 then
      doraemon.x += 1
    elseif t > 150 then
      doraemon.delete_me = true
    end
  end
...

...
a4aaaaaa00000055a4aaaaaa00000055a4aaaaaa000000555666556655566555006000000000000000000000000000005d666566000000000007707000a77070
...

__label__
...
01100000251501a050001001a0501f0501a05000100000000000000000000001f1501a0501f1501a050001001a0501f0501a05000100001000010000100001001f1501a0501f1501a050001001a0501f0501a050
...

__music__
00 04034344
01 12534344
00 12134344
